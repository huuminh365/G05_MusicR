...
class HomeActivity : AppCompatActivity() {
    ...
    var adapterFind: FilterAdapters? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapterFind = FilterAdapters(getFindSong(), this)
